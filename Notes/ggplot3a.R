...
p3 <- ggplot(data=d) +
  ...
  ggbeeswarm::geom_beeswarm(method = "center",size=1)
p3
...
p6 <- ggplot(data=fuel_data) +
  ...
  theme_light(base_size=20,base_family=
                "Monaco") + # that was the basics
  theme(# this is the nitty gritty visual adjustments
...
## mosaic plots ----
# for proportional data (1 or 2 factors). All combinations of factors must be present!
# no zero values
